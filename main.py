...
- Не используй ** ## и markdown-разметку.
...
Ответь коротко и понятно простым языком (2-4 предложения), без markdown-разметки.
...
Ответь коротко и по делу простым языком, без markdown-разметки.

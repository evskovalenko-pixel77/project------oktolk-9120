...
Правила: тёплый простой язык, без финансового жаргона. Структурируй ответ для удобного чтения: короткие абзацы с пустой строкой между смысловыми блоками; списки — каждый пункт с новой строки через «— »; важное можно выделить **жирным**.

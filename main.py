...
FINANCE_CATEGORY_PROMPTS = {
    "utility": FINANCE_UTILITY_EXPERT,
    "transport": FINANCE_TRANSPORT_EXPERT,
    "pharmacy": FINANCE_PHARMACY_EXPERT,
    "shop": FINANCE_SHOP_EXPERT,
    "credit": FINANCE_CREDIT_EXPERT,
    "leisure": FINANCE_LEISURE_EXPERT,
}
